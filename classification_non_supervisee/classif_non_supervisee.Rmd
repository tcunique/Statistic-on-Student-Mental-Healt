...
```
Nous allons donc considéré 4 classes


SI imaginions que nous n'avions pas cette information, alors il faudrait faire dans une boucle while un nombre de fois fini kmeans afin de déterminet quelle est le meilleur nombre de centre tout en réduisant l'erreur.

KMEANS sans K choisi :
```{r}
inertie.intra <- rep(0,times=10)
for (k in 1:10){
  kmeans.result <- kmeans(sub_sante_mentale_numeric,centers=k,nstart=100)
