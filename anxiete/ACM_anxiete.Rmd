...
sub_database_chisq <- sante_mentale %>% 
  dplyr::select(ville_etude,fume,passion,vie_sociale,vie_sociale_periode_controle,ville_etude,Conflits.Familiaux,Conflits.Familiaux,Conflits.Familiaux,Conflits.Familiaux,Conflits.Familiaux)
