...
On fait le test du chi2 afin de savoir quelles sont les variables les plus significatifs
```{r}
...
A partir des résultats du chi2, on crée le csv en prenant en compte que les variables qui sont très significative
```{r}
# Sélection des colonnes avec une valeur p < 0.05
significant_cols <- result_table$p_value < 0.001
...
write.csv(sub_sante_mentale, file = "sub_sante_mentale.csv", row.names = FALSE)
